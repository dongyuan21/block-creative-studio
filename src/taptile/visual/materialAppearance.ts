...
export const TAPTILE_MATERIAL_APPEARANCES: Readonly<Record<TileMaterialId, TapTileMaterialAppearance>> = Object.freeze({
  porcelain: {
    id: 'porcelain',
    radiusRatio: 0.12,
    surfaceOffsetYRatio: -0.04,
    edgeDepthRatio: 0.03,
    fillStops: [[0, '#fffdf8'], [0.56, '#f7f2e8'], [1, '#ddd8cd']],
    edgeColor: '#a7aaae',
    borderColor: 'rgba(116, 119, 122, 0.72)',
    shadowColor: 'rgba(4, 13, 28, 0.42)',
    shadowBlurRatio: 0.07,
    textureOpacity: 0.34,
  ...
  jelly: {
    ...
    shadowColor: 'rgba(6, 29, 70, 0.48)',
    shadowBlurRatio: 0.085,
    textureOpacity: 0.08,
