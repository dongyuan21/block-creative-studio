...
import { BlockPlacementAssetPanel } from './BlockPlacementAssetPanel';
import { BlockPlacementStatus } from './BlockPlacementStatus';
import { useBlockPlacementModel } from './useBlockPlacementModel';

export function BlockPlacementWorkspace() {
  const studio = useBlockPlacementModel();
  ...
  return (
    <div className="studio-app">
      ...
      />
      <BlockPlacementStatus mode={studio.mode} snapshot={displaySnapshot} />
    </div>
  );
}
